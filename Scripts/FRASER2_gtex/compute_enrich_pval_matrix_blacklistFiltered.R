...
#'   output:
#'     - pval_matrix: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK{k}_{quantile}_minN{n}/{implementation}/optQ__newFilt/{psiType}/blacklistFiltered_pval_matrix__{dPsi}__{minCoverage}__{rho}__{act}.tsv.gz"`'
#'   type: script
#'---
