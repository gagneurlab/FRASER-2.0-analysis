#'---
#' title: Compute pvalue matrix for enrichment (FRASER1 new filtering, 5-quantile)
...
#'   output:
#'     - pval_matrix: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_5_minN10/PCA/FRASER1_optQ/{psiType}/pval_matrix__{dPsi}__{minCoverage}__{rho}__{act}.tsv.gz"`'
#'   type: script
#'---
