...
#'   output:
#'     - wBhtml: '`sm config["htmlOutputPath"] + "/{dataset_group}/variant_enrichment/{dataset}/FRASER2_final_variant_enrichment_{snptype}.html"`'
#'     - gg_rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/FRASER2_final_enrichment_plots_{snptype}.Rds"`'
#'     - rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/FRASER2_final_enrichment_data_{snptype}.Rds"`'
#'   type: noindex
#' output:
#'   html_document
#'---

# #'     - FRASER2_PCA_k20_q5_n1_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_5_minN1/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
