...
#'     - mem_mb: 50000
#'   input:
#'     - fraser2_delta01: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.1__5__0.1.tsv.gz"`'
#'     - fraser2_delta02: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.2__5__0.1.tsv.gz"`'
#'     - fraser2_delta03: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
#'     - fraser2_delta04: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.4__5__0.1.tsv.gz"`'
#'     - fraser2_delta05: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.5__5__0.1.tsv.gz"`'
#'     - fraser2_blacklist: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1.tsv.gz"`'
#'     - fraser2_noRho: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix__0.3__5__1.tsv.gz"`'
#'     - fraser2_rho_inverted: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/pval_matrix_invertedFilters__0__0__0.1.tsv.gz"`'
#'     - fraser2_blacklist_inverted: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/jaccard/blacklistInverted_pval_matrix__0__0__1.tsv.gz"`'
#'     - fraser: '`sm config["DATADIR"] + "/{dataset}/optQ__newFilt/FRASER_pval_matrix__0.3__5__1.tsv.gz"`'
#'     - variant_table: '`sm get_input_variants`'
#'   output:
#'     - wBhtml: '`sm config["htmlOutputPath"] + "/variant_enrichment/{dataset}/optQ_newFilt_variant_enrichment_jaccard.html"`'
#'     - gg_rds: '`sm config["DATADIR"] + "/{dataset}/plot_rds/optQ__newFilt/jaccard_enrichment_plots.Rds"`'
#'     - rds: '`sm config["DATADIR"] + "/{dataset}/plot_rds/optQ__newFilt/jaccard_enrichment_data.Rds"`'
#'   type: noindex
#' output:
#'   html_document
#'---
