#'---
#' title: Compare FRASER2 (jaccard) to FRASER1 version, on optimal q
#' author: Ines Scheller
#' wb:
#'   log:
#'    - snakemake: '`sm config["log_dir"] + "/snakemake/{dataset_group}/{dataset}/FRASER2_var_enrich_{snptype}.Rds"`'
#'   py:
#'   - |
...
#'     - mem_mb: 60000
#'   input:
#'     - FRASER2_PCA_k20_q95_n1_pc1_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q95_n1_pc05_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.5/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q95_n1_pc025_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.25/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q95_n1_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q95_n1_pc005_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.05/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q95_n1_pc001_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.01/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q75_n5_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_75_minN5/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k20_q25_n10_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_25_minN10/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER2_PCA_k10_q25_n10_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK10_25_minN10/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
#'     - FRASER1_PCA_k20_q95_n1_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/optQ/FRASER_pval_matrix__0.3__5__1.tsv.gz"`'
#'     - variant_table: '`sm get_input_variants`'
#'   output:
#'     - wBhtml: '`sm config["htmlOutputPath"] + "/{dataset_group}/variant_enrichment/{dataset}/FRASER2_variant_enrichment_{snptype}.html"`'
#'     - gg_rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/FRASER2_enrichment_plots_{snptype}.Rds"`'
#'     - rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/FRASER2_enrichment_data_{snptype}.Rds"`'
#'   type: noindex
#' output:
#'   html_document
#'---

# #'     - FRASER1_PCA_k20_q5_n1_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/optQ__newFilt/FRASER_pval_matrix__0.3__5__1.tsv.gz"`'

# #'     - FRASER2_PCA_k10_q75_n5_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK10_75_minN5/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k5_q95_n10_pc01_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK5_95_minN10/PCA__pc0.1/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n1_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n1_pc01_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.1/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n1_pc001_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.01/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n1_pc0001_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc0.001/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q75_n5_pc01_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_75_minN5/PCA__pc0.1/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n1_pc1e10: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA__pc1e-10/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__FALSE.tsv.gz"`'
# #'     - FRASER2_PCA_k20_q95_n10_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN10/PCA/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
# #'     - FRASER2_BB_k20_q95_n1_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA-BB-Decoder/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
# #'     - FRASER2_BB_k20_q95_n1_noAct_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA-BB-Decoder/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1__TRUE.tsv.gz"`'
# #'     - FRASER2_BB_k20_q95_n1_blacklist_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN1/PCA-BB-Decoder/optQ__newFilt/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1.tsv.gz"`'
# #'     - FRASER2_BB_k20_q95_n10_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/minK20_95_minN10/PCA-BB-Decoder/optQ__newFilt/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
...
rrdt[, Method:=factor(Method,  levels=sort(gsub("_p$", "", methods2plot)))]
                      # levels=c("FRASER1_k20_q95_n1", "FRASER1_k20_q5_n1",
                      #                  "FRASER2_PCA_k20_q95_n1", "FRASER2_BB_k20_q95_n1",
                      #                  "FRASER2_PCA_k20_q95_pc01_n1", "FRASER2_PCA_k20_q95_pc001_n1",
                      #                  "FRASER2_PCA_k20_q95_n1_blacklist", "FRASER2_BB_k20_q95_n1_blacklist",
                      #                  "FRASER2_PCA_k20_q95_n1_noAct", "FRASER2_BB_k20_q95_n1_noAct"))]
                                      # "FRASER2_PCA_k20_q95_n10", "FRASER2_BB_k20_q95_n10"))]
rrdt
...
#'
dt_tmp <- rbindlist(lapply(names(enrich_final_ls[5:8]), function(x){
...
dt4cutoffs[, Method:=factor(Method, levels=sort(gsub("_p$", "", methods2plot)))]
                            # c("FRASER1_k20_q95_n1", "FRASER1_k20_q5_n1",
                            #           "FRASER2_PCA_k20_q95_n1", "FRASER2_BB_k20_q95_n1",
                            #           "FRASER2_PCA_k20_q95_pc01_n1", "FRASER2_PCA_k20_q95_pc001_n1",
                            #           "FRASER2_PCA_k20_q95_n1_blacklist", "FRASER2_BB_k20_q95_n1_blacklist",
                            #           "FRASER2_PCA_k20_q95_n1_noAct", "FRASER2_BB_k20_q95_n1_noAct"))]
