...
#' wb:
#'   log:
#'    - snakemake: '`sm config["log_dir"] + "/snakemake/{dataset_group}/{dataset}/{filt}/FRASER2_deltaJaccard_rv_recall_pc{pc}_rho{rho}_{snptype}.Rds"`'
#'   py:
#'   - |
...
#'     - mem_mb: 50000
#'   input:
#'     - dJ_0_7_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.7__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_5_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.5__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_4_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.4__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_3_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.3__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_2_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.2__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_1_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.1__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_05_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0.05__5__{rho}__FALSE.tsv.gz"`'
#'     - dJ_0_0_p: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/{filt}/PCA__pc{pc}/optQ__newFilt/jaccard/pval_matrix__0__5__{rho}__FALSE.tsv.gz"`'
#'     - variant_table: '`sm get_input_variants`'
#'   output:
#'     - wBhtml: '`sm config["htmlOutputPath"] + "/{dataset_group}/variant_enrichment/{dataset}/{filt}/FRASER2_deltaJaccard_rv_recall_pc{pc}_rho{rho}_{snptype}.html"`'
#'     - gg_rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/{filt}/FRASER2_deltaJaccard_rv_recall_plots_pc{pc}_rho{rho}_{snptype}.Rds"`'
#'     - rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/FRASER2_enrichment/{filt}/FRASER2_deltaJaccard_rv_recall_data_pc{pc}_rho{rho}_{snptype}.Rds"`'
#'     - recall_at_x_outliers_rds: '`sm config["DATADIR"] + "/{dataset_group}/{dataset}/plot_rds/{filt}/FRASER2_enrichment/FRASER2_deltaJaccard_recall_at_x_outliers_pc{pc}_rho{rho}_{snptype}.Rds"`'
#'   type: noindex
#' output:
#'   html_document
#'---
...
all_methods <- sort(gsub("_", ".", gsub("dJ_", "", gsub("_p$", "", methods2plot))))
...
for(maxRank in c(10000, 20000, 50000, 100000)){
    ggplots[[paste0('recall_n=', maxRank)]] <- plotRecallRankForEnrichment(
        ...
        guides(shape=guide_legend(title=ifelse(all(dt4cutoffs[,Type == "P-value"]), "Nominal\np-value cutoff", "Cutoff"), order = 2),
               color=guide_legend(title=bquote(Delta~J), order = 1)) +
