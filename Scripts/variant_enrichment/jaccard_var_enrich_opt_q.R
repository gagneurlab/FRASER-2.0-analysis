...
#' wb:
#'   log:
#'    - snakemake: '`sm config["log_dir"] + "/snakemake/{dataset}/jaccard_var_enrich_optQ.Rds"`'
#'   py:
#'   - |
...
#'     - mem_mb: 50000
#'   input:
#'     - fraser2_delta01: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.1__5__0.1.tsv.gz"`'
#'     - fraser2_delta02: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.2__5__0.1.tsv.gz"`'
#'     - fraser2_delta03: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.3__5__0.1.tsv.gz"`'
#'     - fraser2_delta04: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.4__5__0.1.tsv.gz"`'
#'     - fraser2_delta05: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.5__5__0.1.tsv.gz"`'
#'     - fraser2_blacklist: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/blacklistFiltered_pval_matrix__0.3__5__0.1.tsv.gz"`'
#'     - fraser2_noRho: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix__0.3__5__1.tsv.gz"`'
#'     - fraser2_rho_inverted: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/pval_matrix_invertedFilters__0__0__0.1.tsv.gz"`'
#'     - fraser2_blacklist_inverted: '`sm config["DATADIR"] + "/{dataset}/optQ/jaccard/blacklistInverted_pval_matrix__0__0__1.tsv.gz"`'
#'     - fraser: '`sm config["DATADIR"] + "/{dataset}/optQ/FRASER_pval_matrix__0.3__5__1.tsv.gz"`'
#'     - variant_table: '`sm get_input_variants`'
#'   output:
#'     - wBhtml: '`sm config["htmlOutputPath"] + "/variant_enrichment/{dataset}/optQ_variant_enrichment_jaccard.html"`'
#'     - gg_rds: '`sm config["DATADIR"] + "/{dataset}/plot_rds/optQ/jaccard_enrichment_plots.Rds"`'
#'     - rds: '`sm config["DATADIR"] + "/{dataset}/plot_rds/optQ/jaccard_enrichment_data.Rds"`'
#'   type: noindex
#' output:
#'   html_document
#'---

# #'     - fraser_psi5_psi3: '`sm config["DATADIR"] + "/{dataset}/optQ/FRASER_pval_matrix_psiOnly__0.3__5__1.tsv.gz"`'
# #'     - fraser_theta: '`sm config["DATADIR"] + "/{dataset}/optQ/theta/pval_matrix__0.3__5__1.tsv.gz"`'
...
input_files[["FRASER2_rho>0.1_p"]] <- snakemake@input$fraser2_rho_inverted
input_files[["FRASER2_blacklist_inverted_p"]] <- snakemake@input$fraser2_blacklist_inverted
...
rrdt[, Method:=factor(Method, levels=c("FRASER", "FRASER2_delta>=0.3+blacklist", "FRASER2_delta>=0.1", "FRASER2_delta>=0.2", "FRASER2_delta>=0.3", "FRASER2_delta>=0.3_noRhoCutoff", "FRASER2_delta>=0.4", "FRASER2_delta>=0.5", "FRASER2_rho>0.1", "FRASER2_blacklist_inverted"))]
rrdt
...
dt4cutoffs[, Method:=factor(Method, levels=c("FRASER", "FRASER2_delta>=0.3+blacklist", "FRASER2_delta>=0.1", "FRASER2_delta>=0.2", "FRASER2_delta>=0.3", "FRASER2_delta>=0.3_noRhoCutoff", "FRASER2_delta>=0.4", "FRASER2_delta>=0.5", "FRASER2_rho>0.1", "FRASER2_blacklist_inverted"))]
dt4cutoffs
