...
#'    - mem_mb: 16000
#'   input:
#'    - Figure1:   '`sm config["PAPER_FIGDIR"] + "/Fig1_full.pdf"`'
#'    - Figure2:   '`sm config["PAPER_FIGDIR"] + "/Fig2_recallAt20.pdf"`'
#'    - Figure3:   '`sm config["PAPER_FIGDIR"] + "/Fig3.pdf"`'
#'    - Figure4:   '`sm config["PAPER_FIGDIR"] + "/Fig4.pdf"`'
#'    - FigureS01:   '`sm config["PAPER_FIGDIR"] + "/FigS1_comp_psi_jaccard.pdf"`'
#'    - FigureS02:   '`sm config["PAPER_FIGDIR"] + "/FigS1.pdf"`'
#'    - FigureS03:   '`sm config["PAPER_FIGDIR"] + "/Fig2_recallAt10.pdf"`'
#'    - FigureS04:   '`sm config["PAPER_FIGDIR"] + "/FigS3_recallAt20.pdf"`'
#'    - FigureS05:   '`sm config["PAPER_FIGDIR"] + "/FigS4_recallAt20.pdf"`'
#'    - FigureS06:   '`sm config["PAPER_FIGDIR"] + "/FigS5.pdf"`'
#'    - FigureS07:   '`sm config["PAPER_FIGDIR"] + "/FigS7.pdf"`'
#'    - FigureS08:   '`sm config["PAPER_FIGDIR"] + "/FigS8.pdf"`'
#'    - FigureS09:   '`sm config["PAPER_FIGDIR"] + "/FigS9.pdf"`'
#'   output:
